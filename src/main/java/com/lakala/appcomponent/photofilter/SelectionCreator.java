...
public final class SelectionCreator {
    private final PhotoFilterManager mPhotoFilter;
     ...
     */
    SelectionCreator(PhotoFilterManager photoFilter, @NonNull Set<MimeType> mimeTypes, boolean mediaTypeExclusive) {
    ...
    public SelectionCreator setFilter(boolean setFilter) {
        mSelectionSpec.setFilter = setFilter;
        return this;
    }
     ...
     * <p>
     * It's a redundant API with {@link PhotoFilterManager#obtainResult(Intent)},
