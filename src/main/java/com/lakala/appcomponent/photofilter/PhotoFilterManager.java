...
/**
 * Entry for PhotoFilterManager's media selection.
 */
public final class PhotoFilterManager {

    private final WeakReference<Activity> mContext;
    private final WeakReference<Fragment> mFragment;

    private PhotoFilterManager(Activity activity) {
        this(activity, null);
    }

    private PhotoFilterManager(Fragment fragment) {
        this(fragment.getActivity(), fragment);
    }

    private PhotoFilterManager(Activity activity, Fragment fragment) {
        mContext = new WeakReference<>(activity);
        mFragment = new WeakReference<>(fragment);
    }

    /**
     * Start PhotoFilterManager from an Activity.
     * <p>
     * This Activity's {@link Activity#onActivityResult(int, int, Intent)} will be called when user
     * finishes selecting.
     *
     * @param activity Activity instance.
     * @return PhotoFilterManager instance.
     */
    public static PhotoFilterManager from(Activity activity) {
        return new PhotoFilterManager(activity);
    }

    /**
     * Start PhotoFilterManager from a Fragment.
     * <p>
     ...
     * @return PhotoFilterManager instance.
     */
    public static PhotoFilterManager from(Fragment fragment) {
        return new PhotoFilterManager(fragment);
    }
    ...
    public static List<Uri> obtainResult(Intent data) {
        return data.getParcelableArrayListExtra(PhotoFilterActivity.EXTRA_RESULT_SELECTION);
    }
    ...
    public static List<String> obtainPathResult(Intent data) {
        return data.getStringArrayListExtra(PhotoFilterActivity.EXTRA_RESULT_SELECTION_PATH);
    }
    ...
    public static boolean obtainOriginalState(Intent data) {
        return data.getBooleanExtra(PhotoFilterActivity.EXTRA_RESULT_ORIGINAL_ENABLE, false);
    }
